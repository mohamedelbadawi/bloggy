    ...
    return (
        ...
        <div>
            ...
            <div className='flex items-center justify-center gap-10'>
                ...
                {
                    (status === 'authenticated') ? (<Link href='/posts/write' className="text-white  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mx-0 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add post</Link>) : ''
                }
            </div>
                    ...
                    (filteredPosts && filteredPosts.length > 0) ? filteredPosts.map((post) => {
                        ...
                        return (<div key={post._id} class="w-2/3 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <div className='flex justify-end gap-1'>
                                {post.userId.image ?
                                    (<Image src={post.userId.image} alt="alt" width={40} height={40} />) :
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                    </svg>

                                }
                                <h4 className="">{post.userId.fullname}</h4>
                            </div>
                            ...
                            <button className='flex items-center' onClick={(e) => { handleLike(e, post._id) }} >
